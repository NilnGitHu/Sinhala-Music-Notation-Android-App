...
import com.example.musicnotationapp.databinding.ActivityPdfAddBinding;
...
public class PdfAddActivity extends AppCompatActivity {
    ...
    private void validateData() {
        ...
        if(TextUtils.isEmpty(title)){
            ...
            Toast.makeText(this, "Enter Melody...", Toast.LENGTH_SHORT).show();
        } else if (TextUtils.isEmpty(selectedCategoryTitle)) {
            Toast.makeText(this, "Pick Singer...", Toast.LENGTH_SHORT).show();
        } else if (pdfUri == null) {
    ...
    private void uploadPdfToStorage() {
        ...
        String filePathAndName = "Songs/" + timestamp + ".pdf";
    ...
    private void categoryPickDialog() {
        ...
        builder.setTitle("Select Singer")
